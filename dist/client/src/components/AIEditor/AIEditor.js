...
const AIEditor = ({ language = 'typescript' }) => {
    ...
    return (<div className="ai-editor">
      <div className="editor-container">
        <Editor height="70vh" defaultLanguage={language} value={code} onMount={handleEditorDidMount} onChange={(value) => setCode(value || '')} options={{
        ...
        {suggestion && (<div className="suggestion-popup">
            <pre>{suggestion}</pre>
      ...
      <div className="ai-sidebar">
        <div className="ai-controls">
          <button className="button-primary" onClick={requestSuggestion} disabled={isLoading}>
